...
#ifndef INC_STM32F103X8_EXTI_DRIVERS_H_
#define INC_STM32F103X8_EXTI_DRIVERS_H_
//-----------------------------
//Includes
//-----------------------------
...
typedef struct{
	uint8_t          EXTI_NUM;
	typedef_GPIO*    PORT_NUM;
	uint16_t         PIN_NUM;
	uint8_t          NVIC_IRQ_NUM;


}EXTI_GPIO_Mapping_t;

typedef struct{
	EXTI_GPIO_Mapping_t  exti_conf;        // Specifies the EXTI_GPIO_Mapping_t to be configured.
                                            // This parameter can be a value of @ref EXTI_GPIO_Mapping_t_define
	uint8_t               trigger_case;    // Specifies the riseing or falling or poth to be configured.
                                          // This parameter can be a value of @ref trigger_define

    uint8_t               IRQ_EN ;         // Specifies the EXTI_masked or NVIC_Enable to be configured.
                                           // This parameter can be a value of @ref IRQ_EN_define
...
//@ref EXTI_GPIO_Mapping_t_define
...
#define EXTI_Trigger_Raising                1
#define EXTI_Trigger_Poth_Raising_falling   2
